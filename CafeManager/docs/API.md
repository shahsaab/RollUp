# API Documentation - Scandish

Scandish provides a RESTful API layer alongside its Blazor interface for potential integration with mobile apps or third-party services.
